...
function x() {
  ...
  for (i.sort(f); n2 = i.shift(); )
    n2.__d && (l3 = i.length, t3 = void 0, o4 = void 0, r3 = void 0, c3 = (e3 = (u3 = n2).__v).__e, (s3 = u3.__P) && (t3 = [], o4 = [], (r3 = v({}, e3)).__v = e3.__v + 1, L(s3, e3, r3, u3.__n, void 0 !== s3.ownerSVGElement, null != e3.__h ? [c3] : null, t3, null == c3 ? g(e3) : c3, e3.__h, o4), M(t3, e3, o4), e3.__e != c3 && m(e3)), i.length > l3 && i.sort(f));
  x.__r = 0;
}
function P(n2, l3, u3, t3, i3, o4, r3, f3, e3, a3, v3) {
  var p3, y3, _4, b3, g4, m3, w4, x4, P4, S2, H3 = 0, I3 = t3 && t3.__k || s, T4 = I3.length, j4 = T4, z4 = l3.length;
  for (u3.__k = [], p3 = 0; p3 < z4; p3++)
    null != (b3 = u3.__k[p3] = null == (b3 = l3[p3]) || "boolean" == typeof b3 || "function" == typeof b3 ? null : "string" == typeof b3 || "number" == typeof b3 || "bigint" == typeof b3 ? d(null, b3, null, null, b3) : h(b3) ? d(k, { children: b3 }, null, null, null) : b3.__b > 0 ? d(b3.type, b3.props, b3.key, b3.ref ? b3.ref : null, b3.__v) : b3) && (b3.__ = u3, b3.__b = u3.__b + 1, -1 === (x4 = A(b3, I3, w4 = p3 + H3, j4)) ? _4 = c : (_4 = I3[x4] || c, I3[x4] = void 0, j4--), L(n2, b3, _4, i3, o4, r3, f3, e3, a3, v3), g4 = b3.__e, (y3 = b3.ref) && _4.ref != y3 && (_4.ref && O(_4.ref, null, b3), v3.push(y3, b3.__c || g4, b3)), null != g4 && (null == m3 && (m3 = g4), S2 = !(P4 = _4 === c || null === _4.__v) && x4 === w4, P4 ? -1 == x4 && H3-- : x4 !== w4 && (x4 === w4 + 1 ? (H3++, S2 = true) : x4 > w4 ? j4 > z4 - w4 ? (H3 += x4 - w4, S2 = true) : H3-- : H3 = x4 < w4 && x4 == w4 - 1 ? x4 - w4 : 0), w4 = p3 + H3, S2 = S2 || x4 == p3 && !P4, "function" != typeof b3.type || x4 === w4 && _4.__k !== b3.__k ? "function" == typeof b3.type || S2 ? void 0 !== b3.__d ? (e3 = b3.__d, b3.__d = void 0) : e3 = g4.nextSibling : e3 = $(n2, g4, e3) : e3 = C(b3, e3, n2), "function" == typeof u3.type && (u3.__d = e3)));
  for (u3.__e = m3, p3 = T4; p3--; )
...
function C(n2, l3, u3) {
  for (var t3, i3 = n2.__k, o4 = 0; i3 && o4 < i3.length; o4++)
    (t3 = i3[o4]) && (t3.__ = n2, l3 = "function" == typeof t3.type ? C(t3, l3, u3) : $(u3, t3.__e, l3));
  return l3;
}
function S(n2, l3) {
...
function T(n2, l3, u3, t3, i3) {
  ...
  n:
    if ("style" === l3)
      ...
      o4 = l3 !== (l3 = l3.replace(/Capture$/, "")), l3 = l3.toLowerCase() in n2 ? l3.toLowerCase().slice(2) : l3.slice(2), n2.l || (n2.l = {}), n2.l[l3 + o4] = u3, u3 ? t3 || n2.addEventListener(l3, o4 ? z : j, o4) : n2.removeEventListener(l3, o4 ? z : j, o4);
...
function L(n2, u3, t3, i3, o4, r3, f3, e3, c3, s3) {
  var a3, p3, y3, d3, _4, g4, m3, w4, x4, C3, S2, $3, A4, H3, I3, T4 = u3.type;
  ...
  try {
    n:
      if ("function" == typeof T4) {
        if (w4 = u3.props, x4 = (a3 = T4.contextType) && i3[a3.__c], C3 = a3 ? x4 ? x4.props.value : a3.__ : i3, t3.__c ? m3 = (p3 = u3.__c = t3.__c).__ = p3.__E : ("prototype" in T4 && T4.prototype.render ? u3.__c = p3 = new T4(w4, C3) : (u3.__c = p3 = new b(w4, C3), p3.constructor = T4, p3.render = B), x4 && x4.sub(p3), p3.props = w4, p3.state || (p3.state = {}), p3.context = C3, p3.__n = i3, y3 = p3.__d = true, p3.__h = [], p3._sb = []), null == p3.__s && (p3.__s = p3.state), null != T4.getDerivedStateFromProps && (p3.__s == p3.state && (p3.__s = v({}, p3.__s)), v(p3.__s, T4.getDerivedStateFromProps(w4, p3.__s))), d3 = p3.props, _4 = p3.state, p3.__v = u3, y3)
          ...
          if (null == T4.getDerivedStateFromProps && w4 !== d3 && null != p3.componentWillReceiveProps && p3.componentWillReceiveProps(w4, C3), !p3.__e && (null != p3.shouldComponentUpdate && false === p3.shouldComponentUpdate(w4, p3.__s, C3) || u3.__v === t3.__v)) {
          ...
          null != p3.componentWillUpdate && p3.componentWillUpdate(w4, p3.__s, C3), null != p3.componentDidUpdate && p3.__h.push(function() {
            p3.componentDidUpdate(d3, _4, g4);
          });
        }
        if (p3.context = C3, p3.props = w4, p3.__P = n2, p3.__e = false, $3 = l.__r, A4 = 0, "prototype" in T4 && T4.prototype.render) {
        ...
        p3.state = p3.__s, null != p3.getChildContext && (i3 = v(v({}, i3), p3.getChildContext())), y3 || null == p3.getSnapshotBeforeUpdate || (g4 = p3.getSnapshotBeforeUpdate(d3, _4)), P(n2, h(I3 = null != a3 && a3.type === k && null == a3.key ? a3.props.children : a3) ? I3 : [I3], u3, t3, i3, o4, r3, f3, e3, c3, s3), p3.base = u3.__e, u3.__h = null, p3.__h.length && f3.push(p3), m3 && (p3.__E = p3.__ = null);
      } else
        null == r3 && u3.__v === t3.__v ? (u3.__k = t3.__k, u3.__e = t3.__e) : u3.__e = N(t3.__e, u3, t3, i3, o4, r3, f3, c3, s3);
    (a3 = l.diffed) && a3(u3);
  } catch (n3) {
...
function N(l3, u3, t3, i3, o4, r3, f3, e3, s3) {
  ...
  if (null === k4)
    ...
    if (r3 = r3 && n.call(l3.childNodes), v3 = (d3 = t3.props || c).dangerouslySetInnerHTML, y3 = _4.dangerouslySetInnerHTML, !e3) {
      if (null != r3)
    ...
    if (H(l3, _4, d3, o4, e3), y3)
      u3.__k = [];
    else if (P(l3, h(b3 = u3.props.children) ? b3 : [b3], u3, t3, i3, o4 && "foreignObject" !== k4, r3, f3, r3 ? r3[0] : t3.__k && g(t3, 0), e3, s3), null != r3)
      for (b3 = r3.length; b3--; )
        null != r3[b3] && p(r3[b3]);
      ...
      !function() {
        ...
        var UploadWidget = function UploadWidget2(_ref) {
          ...
          var doUpload = UploadWidget_async(function(file, fileIndex) {
            ...
            if (mimeTypes2 !== void 0 && !mimeTypes2.includes(file.type)) {
